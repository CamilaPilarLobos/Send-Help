...
const songsController = {
    ...
    createOne : async (req, res)=> {
        const {title, artist, yearOfRealease, genero } = req.body;
        const newArray = {title, artist,yearOfRealease,genero} 
        try{
    ...
    deleteOne: async (req,res)=> {
        ...
        try{
            ...
            res.status(201).json({message: "borraste la cancion exitosamente"})
        }catch(e){
            return res.status(400).json(e)
        }
    },
